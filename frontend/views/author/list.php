...
<div class="row">
	...
	<?php foreach($authors as $author): ?>
		<div class="col-lg-3 col-md-4 col-ls-4 col-xs-6">
			...
			?>
			<div title='<?= $author->name ?>' style='background: url(/images/authors/<?= $author->image ?>) no-repeat center; background-size: contain; width: 150px; height: 150px; margin: 0 auto;'>
			</div>
			<p class="text-center" style="margin-bottom: 25px;"><?= $author->name ?></p>
		</div>
