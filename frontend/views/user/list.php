	...
	<?php foreach($users as $user): ?>
		<div class="col-lg-3 col-md-4 col-ls-4 col-xs-6">
			<?= Html::a("<div></div>", ['user/view', 'id' => $user->id], [
				'title' => $user->name,
				'style' => 'background: url(/images/users/'.$user->image.') no-repeat center; background-size: cover; width: 200px; height: 200px; margin: 0 auto; border-radius: 100px; display: block;>',
			]);
			?>
